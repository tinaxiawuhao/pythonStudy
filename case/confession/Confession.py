...
if __name__ == '__main__':
	text = open('case/confession/material/words.txt').read()
	choice = input('words.txt中内容是否为中文(y/n)：')
	if choice == 'y' or 'Y':
		stopwords = importStopword(filename='case/confession/material/StopWords.txt')
	...
	plt.axis("off")
	plt.show()
	WC.to_file("case/confession/results/LOVE.png")