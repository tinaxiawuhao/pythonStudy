...
if __name__ == '__main__':
	ea = easy_analysis()
	ea.find_main_characters(text1='case/novel/tianlong.txt', text2='case/novel/tl_names.txt', title='天龙八部')
	ea.add_key_words(ea.get_key_words('case/novel/tl_names.txt'))
	model = ea.training('case/novel/tianlong.txt')
	model.save('model')
